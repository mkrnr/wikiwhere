...
parser.add_argument("--language", dest="language", metavar='two-letter country code', type=str, help="one of the language editions of dbpedia (default: en)", required=True)
