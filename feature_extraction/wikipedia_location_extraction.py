...
parser.add_argument("--language", dest="language", metavar='two-letter country code', required=True, type=str, help="on of the language editions of dbpedia (default: en):")
